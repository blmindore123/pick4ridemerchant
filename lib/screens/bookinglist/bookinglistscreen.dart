...
//                                          Text("Booking No. ${bookingListController.bookingListModel?.data[index].id}",style: TextStyle(color: Colors.blue),),
                                              ...
                                              ElevatedButton(
                                                  ...
                                                  onPressed: () {
                                                            ...
                                                            builder: (context) =>
                                                                BookingDetails(
                                                                    ...
                                                                    id:
                                                                        bookvehiclesid,
                                                                    status:
                                                                        bookingListController.bookingListModel?.data[index].bookingStatus ??
                                                                            '',
                                                                    datepick:
                                                                        result ??
                                                                            '',
                                                    ...
                                                    print(
                                                        "id in list:${bookingListController.bookingListModel?.data[index].id}");
                                                    print(
...
//        ),
  ...
  void acceptrejectbook(
      int? bookid, String? status, String? rejectreason) async {
    try {
