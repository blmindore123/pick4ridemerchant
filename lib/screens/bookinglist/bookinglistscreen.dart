                      ...
                      bookingListController.isLoadingbookinglist.value
                        ...
                        child: CircularProgressIndicator(),
                          ...
                          itemCount: bookingListController
                              .bookingListModel?.data.length ??
                              0,
                          itemBuilder: (context, index) {
                            String pickdates = bookingListController
                                .bookingListModel
                                ?.data[index]
                                .pickupDate ??
                                '';
                            String result = pickdates.substring(
                                0, pickdates.indexOf('00:00:00'));

                            print(result);

                            String dropdates = bookingListController
                                .bookingListModel
                                ?.data[index]
                                .dropOffDate ??
                                '';
                            String result2 = dropdates.substring(
                                0, dropdates.indexOf('00:00:00'));

                            print(result2);

                            int? bookvehiclesid = bookingListController
                                .bookingListModel?.data[index].vehicle.id;
                            ...
                            i <
                                bookingListController
                                    ...
                                    .length;
                            i++) {
                              imagevehicledet = bookingListController
                                  .bookingListModel!
                                  .data[index]
                                  .vehicle
                                  .images[i]
                                        ...
                                        Align(
                                            ...
                                            child: Text(
                                              'Category - ${bookingListController
                                                  .bookingListModel?.data[index]
                                                  .vehicle.rideCategory.name}',
                                              style: TextStyle(
                                                  fontWeight:
                                                  FontWeight.w300),
                                            )),
...
//                                          Text("Booking No. ${bookingListController.bookingListModel?.data[index].id}",style: TextStyle(color: Colors.blue),),
                                        ...
                                        ElevatedButton(
                                          ...
                                          onPressed: () {
                                                ...
                                                MaterialPageRoute(
                                                    builder: (context) =>
                                                        BookingDetails(
                                                            ...
                                                            vehiclename: bookingListController
                                                                .bookingListModel
                                                                ?.data[index]
                                                                .vehicle
                                                                .vehicleCategory
                                                                .name ??
                                                                '',
                                                            vehicleprice: bookingListController
                                                                .bookingListModel
                                                                ?.data[index]
                                                                .bookingAmount ??
                                                                '',
                                                            vehicleluggage: bookingListController
                                                                .bookingListModel
                                                                ?.data[index]
                                                                .vehicle
                                                                .noOfLuggageSpace ??
                                                                '',
                                                            addresspickup: bookingListController
                                                                .bookingListModel
                                                                ?.data[index]
                                                                .pickupPoint ??
                                                                '',
                                                            addressdropoff: bookingListController
                                                                .bookingListModel
                                                                ?.data[index]
                                                                .dropOffPoint ??
                                                                '',
                                                            fuel: bookingListController
                                                                .bookingListModel
                                                                ?.data[index]
                                                                .vehicle
                                                                .fuelType ?? '',
                                                            vehiclenumber: bookingListController
                                                                .bookingListModel
                                                                ?.data[index]
                                                                .vehicle
                                                                .vehicleNo ??
                                                                '',
                                                            customername: bookingListController
                                                                .bookingListModel
                                                                ?.data[index]
                                                                .customer
                                                                .fullName ??
                                            ...
                                            print(
                                                "id in list:${bookingListController
                                                    .bookingListModel
                                                    ?.data[index].id}");
                                            print(
                                                "image: $imagevehicledet");
                                          },
                                          child: Text(
...
//        ),
  ...
  void acceptrejectbook(int? bookid, String? status,
    ...
    try {
      ...
      Response response = await put(
          Uri.parse(
              AppConstants.BASE_URL + '/merchant/booking/$bookid/$status'),
          body: json.encode({"cancel_reason": rejectreason}),
          // body: {
      ...
      if (response.statusCode == 200) {
        ...
        String newString =
        oldString.replaceAll('{"success":false,"message":', '');
