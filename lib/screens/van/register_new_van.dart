...
class RegisterNewVan extends StatefulWidget {
  @override
  _RegisterNewVanState createState() => _RegisterNewVanState();
}

class _RegisterNewVanState extends State<RegisterNewVan> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Register New Van",style: TextStyle(color: Colors.black),),
