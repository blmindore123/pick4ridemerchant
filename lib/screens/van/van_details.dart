...
class VanDetails extends StatefulWidget {
  ...
  @override
  _VanDetailsState createState() => _VanDetailsState();
}

class _VanDetailsState extends State<VanDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Van Details",style: TextStyle(color: Colors.black),),
